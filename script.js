...
var DashboardLayout = (function () {
    ...
    var WIDGET_DEFAULTS = [
        { id: 'widget-nw', x: 0, y: 0, w: 8, h: 2, minW: 4, minH: 2 },
        { id: 'widget-ytd', x: 8, y: 0, w: 4, h: 2, minW: 3, minH: 2 },
        { id: 'widget-insights', x: 0, y: 2, w: 12, h: 2, minW: 4, minH: 2 },
        { id: 'widget-milestones', x: 0, y: 4, w: 12, h: 2, minW: 4, minH: 2 },
        { id: 'widget-main-chart', x: 0, y: 6, w: 12, h: 4, minW: 6, minH: 3 },
        { id: 'widget-pac-chart', x: 0, y: 10, w: 12, h: 4, minW: 6, minH: 3 }
    ];
